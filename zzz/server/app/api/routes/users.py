...
@router.put("/me/notifications", response_model=UserResponseDTO)
...
async def read_users(
    ...
    users = container.user_service.get_users(skip=skip, limit=limit)
    total = container.user_service.get_users_count()
